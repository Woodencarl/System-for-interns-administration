...
class Intern(models.Model):
    ...
    date_of_birth = models.DateField('Datum narození', null=True)
    ...
    learned_from = models.CharField('Dozvěděl se od', max_length=1, choices=LEARNED_FORM_OPTIONS, null=True)
    resume = models.FileField('Životopis', upload_to='resumes/%Y/%m', null=True, blank=True)
    cover_letter = models.FileField('Motivační dopis', upload_to='cover_letters/%Y/%m', null=True, blank=True, )
